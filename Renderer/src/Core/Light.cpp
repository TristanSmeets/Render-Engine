...
Light::Parameters::Parameters(glm::vec3 colour, float constant, float linear, float quadratic) :
	Colour(colour), Constant(constant), Linear(linear), Quadratic(quadratic)
{
}
